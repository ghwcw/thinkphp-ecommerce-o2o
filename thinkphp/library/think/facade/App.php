 ...
 * @method \think\Model model(string $name = '', string $layer = 'model', bool $appendSuffix = false, string $public = 'public') static 实例化模型
 * @method object controller(string $name, string $layer = 'controller', bool $appendSuffix = false, string $empty = '') static 实例化控制器
 * @method \think\Validate validate(string $name = '', string $layer = 'validate', bool $appendSuffix = false, string $public = 'public') static 实例化验证器类
