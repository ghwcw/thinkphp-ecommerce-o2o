...
class App extends Container
{
     ...
     */
    public function create($name, $layer, $appendSuffix = false, $common = 'public')
    {
        $guid = $name . $layer;
     ...
     * @throws ClassNotFoundException
     */
    public function model($name = '', $layer = 'model', $appendSuffix = false, $common = 'public')
    {
     ...
     * @throws ClassNotFoundException
     */
    public function validate($name = '', $layer = 'validate', $appendSuffix = false, $common = 'public')
    {
